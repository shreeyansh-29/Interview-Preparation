...
// We can programmatically configure the useEffect hook by adding a
// condition to detect whether it is invoked on the initial render or not,
// if it is not the initial render then only run our code.
